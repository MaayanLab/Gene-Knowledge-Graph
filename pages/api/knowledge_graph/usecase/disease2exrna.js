...
async function process_query({session, term, limit, schema, aggr_scores, colors, field }) {
    const query = `
    MATCH p=(a:Disease {label: $term})-[r1:\`gene associated with disease or phenotype\`]-(b:Gene)-[r2]-(c:\`Body Substance\`)-[r3: \`correlated in\`]-(d:\`ENCODE RBS 150 NO OVERLAP\`)-[r4: overlaps]-(e: Gene)
