...
async function process_query({
    ...
    const query = `MATCH p = (c:Condition {label: 'brain cancer'})<-[:indicates_risk_of_developing]-(b:Biomarker)-[:indicates_risk_of_developing]->(a:Condition {label: 'thyroid cancer'})
